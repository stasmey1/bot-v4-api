...
from app.materials.category_video.dao import CategoryVideoDAO as Dao
from app.materials.category_video.schemas import (
    OutCategoryVideoSchema as OutSchema,
    CreateCategoryVideoSchema as CreateSchema,
    UpdateCategoryVideoSchema as UpdateSchema
)
